...
<head>
  ...
  <link rel="stylesheet" href="loggedinpage.css">
...
<body class="primary-bg">
    ...
    <div class="image-profile">
      <div class="d-inline-flex justify-content-end profile-hover p-2 ">
        ...
        <div class="d-flex flex-column justify-content-center pl-1">
          ...
          <small class="fs-11">
            <a href="../loginazalpenak" class="text-danger ml-1">LOG OUT</a>
          </small>
        </div>
      </div>
    </div>
    ...
    <div class="row mt-4" id="test">
      <div class="col-6 pl-4 ">
        ...
        <div class="d-flex mt-5">
          <button class="btn secondary-button-outline text-white px-5 py-2 mr-5">
  ...
  <div class="container mt-5 pt-5 p-5">
    ...
    <table class="table table-blue rounded-lg" style="text-align:center">
      <thead style="vertical-align:left" class="">
        ...
        while ($erregistroa = mysqli_fetch_array($emaitza)) {
          printf("<tr >
                          ...
                          <td>%s</td>
                          <td>%s</td>
                        </tr>", $erregistroa[2], $erregistroa[3], $erregistroa[4],);
        }
    ...
    <div class="table text-right">
      <a href="#reservations interaction">
        <button class="btn btn-warning  ml-5 text-white">All Reservations</button>
      </a>
    </div>
  </div>
