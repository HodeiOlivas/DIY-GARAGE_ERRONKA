...
<body class="primary-bg">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-3 container pt-5">
                <form name="f1" class="form-label" action="kontsultatu_workers.php" method="POST">
                    <h5>Identify yourself as a Worker:</h5>
                    <!-- Erabiltzailea -->
                    <div class="d-flex flex-column">
                        <label for="name" id="name" class="fw-bolder fs-6 text-uppercase text-muted"><small>Worker's name:<br></small></label>
                        <input type="text" name="name" class="form-control light-bg-form no-border" placeholder="enter name" required />
                        <br>
                    </div>
                    <div class="d-flex flex-column">
                        <label for="surname" id="surname" class="fw-bolder fs-6 text-uppercase text-muted"><small>Worker's surname:<br></small></label>
                        <input type="text" name="surname" class="form-control light-bg-form no-border" placeholder="enter surname" required />
                    </div>
                    <!-- pasahitza -->
                    <div class="d-flex flex-column pt-4">
                        <label for="pasahitza" id="password" class="fw-bolder fs-6 text-uppercase text-muted"><small> Password:</small></label>
    ...
    ?>
            <div class="d-flex justify-content-center">
                <p style="color:#F00;"><strong>Error!</strong> Your name, surname or password is incorrect. Try again... </b>
                    <!-- <img src="stop.jpg"> -->
            </div>
    <?php
        }
