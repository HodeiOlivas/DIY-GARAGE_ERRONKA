        ...
        <div class="image-profile">
            <div class="d-inline-flex justify-content-end profile-hover p-2 ">
                ...
                <div class="d-flex flex-column justify-content-center pl-1">
                    ...
                    <small class="fs-11">
                        <a href="../finalVersion/sessionsCustomersFinal.php" class="text-danger ml-1">LOG OUT</a>
                    </small>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div style="width: 100%;">
                ...
                <div class="jumbotron text-left" style="width: 50%; margin-bottom:0; color:black">
                    ...
                    <div class="hero-image" style="text-align: right;">
                        <div class="hero-text">
                            <button onclick=location.href="newPurchaseFinalForm.php" style="width:15%;">Manage</button>
                        </div>
                    </div>
                </div>
