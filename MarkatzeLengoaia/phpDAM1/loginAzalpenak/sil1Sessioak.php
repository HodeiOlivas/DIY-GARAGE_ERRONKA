    ...
    <div class="container">
        <div class="row">
            <div class="d-flex justify-content-center align-items-center pt-5 pb-4">
                <!-- Atzera -->
                <div class="col">
                    <a href="../loginazalpenak" class="align-left text-decoration-none">
            ...
            <div class="col-3 container pt-5">
                <form name="f1" class="form-label" action="kontsultatu_erabiltzaileak.php" method="POST">
                    ...
                    <div class="d-flex flex-column">
                        <label for="Erabiltzailea" id="username" class="fw-bolder fs-6 text-uppercase text-muted"><small>Erabiltzailea:</small></label>
                        <input type="text" name="usuario" id="Erabiltzailea" class="form-control light-bg-form no-border" required />
                    </div>

                    <!-- pasahitza -->
                    <div class="d-flex flex-column pt-4">
                        <label for="pasahitza" id="username" class="fw-bolder fs-6 text-uppercase text-muted"><small> Pasahitza:</small></label>
                        <input type="password" name="password" id="pasahitza" class="form-control light-bg-form no-border" required />
                    </div>
